...
// =============================================================================
// v14 (Фаза 2, §7.12 плана): дорожки/окна/рамки. Фикстуры строятся через
// HierarchyUtils.parseNotation — состояние в нотации, а не JSON руками (§1
// плана / §3 docs/LANES_MODEL.md). Тесты ВЫШЕ покрывают функции из списка
// «Удаляются»/«Меняются» под старыми именами — они остаются рабочими и
// проверенными, пока их вызывает живой v13-путь (не трогаются до конца
// Фазы 4). Ниже — функции из списков «Новые» и v14-версии «Меняются» под
// временными именами (суффикс V14).
// =============================================================================
